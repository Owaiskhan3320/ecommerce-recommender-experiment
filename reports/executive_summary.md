...
- **Model signal:** on a chronological 28-day holdout, the co-visitation recommender achieved Recall@10 of 14.334%, compared with 1.069% for a global-popularity baseline. Candidate coverage was 90.671% across eligible holdout purchase examples.
- **Experiment readiness:** a 20% relative-lift planning scenario requires 70,222 eligible assigned visitors per variant at 80% power and two-sided alpha of 0.05. Historical volume suggests about 12 days to sample size, with a 14-day minimum to cover weekly behavior.
