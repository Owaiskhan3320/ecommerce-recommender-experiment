...
Control conversion is 0.640%; treatment conversion is 0.789%. The synthetic treatment-control difference is 0.149% (23.3% relative lift), with a Newcombe 95% score interval of [0.029%, 0.270%] and a pooled two-proportion z-test p-value of 0.000597.

## Guardrail
The treatment-control render-success difference is -0.049%. Its 95% confidence interval lower bound is -0.131%, compared with the pre-specified non-inferiority limit of -0.2%.
