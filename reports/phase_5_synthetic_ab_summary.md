...
Control conversion is 0.640%; treatment conversion is 0.789%. The synthetic treatment-control difference is 0.149% (23.3% relative lift), with a two-sided 95% confidence interval of [0.064%, 0.235%] and p = 0.000597.
...
## Decision exercise
Would meet the pre-specified decision rule in a real experiment. This statement describes only how the rule would be applied to the fabricated scenario. It is not a deployment recommendation and must not be represented as a live A/B-test outcome.
